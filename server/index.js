...
db.serialize(() => {
  ...
  const defaultDishes = [
    ...
    { name: '麻辣烫', categoryName: '麻辣', canteenName: '二食堂', floorName: '三楼', shopName: '麻辣烫', description: '汤底浓郁，菜品新鲜，冬天必吃。', avgScore: 4.4, ratingCount: 76, imageUrl: '/images/dish1.jpg' },
    { name: '烤肉拌饭', categoryName: '盖饭', canteenName: '一食堂', floorName: '三楼', shopName: '烤肉', description: '烤肉焦香，配菜丰富，酱汁很下饭。', avgScore: 4.3, ratingCount: 58, imageUrl: '/images/dish2.jpg' },
    { name: '奶茶', categoryName: '饮品', canteenName: '二食堂', floorName: '二楼', shopName: '奶茶店', description: '饭后一杯，甜度可选，珍珠Q弹。', avgScore: 4.1, ratingCount: 145, imageUrl: '/images/dish3.jpg' },
  ]
